...
#SBATCH --output=/workspace/filesrv02/kito/patch-vector-search/logs/0001_20260808_build_patch_manifest/%j_0001_20260808_build_patch_manifest.out
#SBATCH --error=/workspace/filesrv02/kito/patch-vector-search/logs/0001_20260808_build_patch_manifest/%j_0001_20260808_build_patch_manifest.out
...
# #SBATCH --output=/workspace/filesrv02/kito/patch-vector-search/logs/0001_20260808_build_patch_manifest/%A_%a_0001_20260808_build_patch_manifest.out
# #SBATCH --error=/workspace/filesrv02/kito/patch-vector-search/logs/0001_20260808_build_patch_manifest/%A_%a_0001_20260808_build_patch_manifest.out
# #SBATCH --array=0-N
#
