#!/bin/bash
#SBATCH --job-name=0018_20260909_build_faiss_index_deblank
#SBATCH --partition=large-creator-i
#SBATCH --output=/workspace/filesrv02/kito/patch-vector-search/logs/0018_20260909_build_faiss_index_deblank/%j_0018_20260909_build_faiss_index_deblank.out
#SBATCH --error=/workspace/filesrv02/kito/patch-vector-search/logs/0018_20260909_build_faiss_index_deblank/%j_0018_20260909_build_faiss_index_deblank.out
...
#SBATCH --mem=64g
#SBATCH --time=4:00:00
# CPU-only: FAISSのKMeans/OPQ/PQ学習+全1000ファイルを読んでadd_with_idsする
# 重量級パス(I/O支配)。0002(背景除去なし版)と同一リソース。背景パッチ389,959件
# (2.12%)を除いた分だけコーパスは軽い(17.98M / 18.37M vectors)。GPU不要。
...
# #SBATCH --output=/workspace/filesrv02/kito/patch-vector-search/logs/0018_20260909_build_faiss_index_deblank/%A_%a_0018_20260909_build_faiss_index_deblank.out
# #SBATCH --error=/workspace/filesrv02/kito/patch-vector-search/logs/0018_20260909_build_faiss_index_deblank/%A_%a_0018_20260909_build_faiss_index_deblank.out
# #SBATCH --array=0-N
#
...
export EXP_NAME="0018_20260909_build_faiss_index_deblank"
