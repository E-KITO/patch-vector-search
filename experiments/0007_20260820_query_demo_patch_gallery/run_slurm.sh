#!/bin/bash
#SBATCH --job-name=0007_20260820_query_demo_patch_gallery
#SBATCH --partition=small-creator-i
#SBATCH --output=/workspace/filesrv02/kito/patch-vector-search/logs/0007_20260820_query_demo_patch_gallery/%j_0007_20260820_query_demo_patch_gallery.out
#SBATCH --error=/workspace/filesrv02/kito/patch-vector-search/logs/0007_20260820_query_demo_patch_gallery/%j_0007_20260820_query_demo_patch_gallery.out
...
# #SBATCH --output=/workspace/filesrv02/kito/patch-vector-search/logs/0007_20260820_query_demo_patch_gallery/%A_%a_0007_20260820_query_demo_patch_gallery.out
# #SBATCH --error=/workspace/filesrv02/kito/patch-vector-search/logs/0007_20260820_query_demo_patch_gallery/%A_%a_0007_20260820_query_demo_patch_gallery.out
# #SBATCH --array=0-N
#
...
export EXP_NAME="0007_20260820_query_demo_patch_gallery"
