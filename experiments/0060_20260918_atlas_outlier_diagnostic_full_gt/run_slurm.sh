#!/bin/bash
#SBATCH --job-name=0060_20260918_atlas_outlier_diagnostic_full_gt
#SBATCH --partition=medium-creator-i
#SBATCH --output=/workspace/filesrv02/kito/patch-vector-search/logs/0060_20260918_atlas_outlier_diagnostic_full_gt/%j_0060_20260918_atlas_outlier_diagnostic_full_gt.out
#SBATCH --error=/workspace/filesrv02/kito/patch-vector-search/logs/0060_20260918_atlas_outlier_diagnostic_full_gt/%j_0060_20260918_atlas_outlier_diagnostic_full_gt.out
...
export EXP_NAME="0060_20260918_atlas_outlier_diagnostic_full_gt"
