#!/bin/bash
#SBATCH --job-name=0059_20260918_autoscale_revive_full_gt
#SBATCH --partition=large-creator-i
#SBATCH --output=/workspace/filesrv02/kito/patch-vector-search/logs/0059_20260918_autoscale_revive_full_gt/%j_0059_20260918_autoscale_revive_full_gt.out
#SBATCH --error=/workspace/filesrv02/kito/patch-vector-search/logs/0059_20260918_autoscale_revive_full_gt/%j_0059_20260918_autoscale_revive_full_gt.out
...
export EXP_NAME="0059_20260918_autoscale_revive_full_gt"
