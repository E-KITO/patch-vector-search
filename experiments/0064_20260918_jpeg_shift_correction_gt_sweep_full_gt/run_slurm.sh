#!/bin/bash
#SBATCH --job-name=0064_20260918_jpeg_shift_correction_gt_sweep_full_gt
#SBATCH --partition=large-creator-i
#SBATCH --output=/workspace/filesrv02/kito/patch-vector-search/logs/0064_20260918_jpeg_shift_correction_gt_sweep_full_gt/%j_0064_20260918_jpeg_shift_correction_gt_sweep_full_gt.out
#SBATCH --error=/workspace/filesrv02/kito/patch-vector-search/logs/0064_20260918_jpeg_shift_correction_gt_sweep_full_gt/%j_0064_20260918_jpeg_shift_correction_gt_sweep_full_gt.out
...
export EXP_NAME="0064_20260918_jpeg_shift_correction_gt_sweep_full_gt"
