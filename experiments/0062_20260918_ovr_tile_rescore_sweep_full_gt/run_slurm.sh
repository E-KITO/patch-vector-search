#!/bin/bash
#SBATCH --job-name=0062_20260918_ovr_tile_rescore_sweep_full_gt
#SBATCH --partition=medium-creator-i
#SBATCH --output=/workspace/filesrv02/kito/patch-vector-search/logs/0062_20260918_ovr_tile_rescore_sweep_full_gt/%j_0062_20260918_ovr_tile_rescore_sweep_full_gt.out
#SBATCH --error=/workspace/filesrv02/kito/patch-vector-search/logs/0062_20260918_ovr_tile_rescore_sweep_full_gt/%j_0062_20260918_ovr_tile_rescore_sweep_full_gt.out
...
export EXP_NAME="0062_20260918_ovr_tile_rescore_sweep_full_gt"
