#!/bin/bash
#SBATCH --job-name=0066_20260918_swelling_redeliver_full_gt
#SBATCH --partition=large-creator-i
#SBATCH --output=/workspace/filesrv02/kito/patch-vector-search/logs/0066_20260918_swelling_redeliver_full_gt/%j_0066_20260918_swelling_redeliver_full_gt.out
#SBATCH --error=/workspace/filesrv02/kito/patch-vector-search/logs/0066_20260918_swelling_redeliver_full_gt/%j_0066_20260918_swelling_redeliver_full_gt.out
...
export EXP_NAME="0066_20260918_swelling_redeliver_full_gt"
