#!/bin/bash
#SBATCH --job-name=0008_20260820_query_demo_patch_gallery_hit_threshold
#SBATCH --partition=small-creator-i
#SBATCH --output=/workspace/filesrv02/kito/patch-vector-search/logs/0008_20260820_query_demo_patch_gallery_hit_threshold/%j_0008_20260820_query_demo_patch_gallery_hit_threshold.out
#SBATCH --error=/workspace/filesrv02/kito/patch-vector-search/logs/0008_20260820_query_demo_patch_gallery_hit_threshold/%j_0008_20260820_query_demo_patch_gallery_hit_threshold.out
...
# #SBATCH --output=/workspace/filesrv02/kito/patch-vector-search/logs/0008_20260820_query_demo_patch_gallery_hit_threshold/%A_%a_0008_20260820_query_demo_patch_gallery_hit_threshold.out
# #SBATCH --error=/workspace/filesrv02/kito/patch-vector-search/logs/0008_20260820_query_demo_patch_gallery_hit_threshold/%A_%a_0008_20260820_query_demo_patch_gallery_hit_threshold.out
# #SBATCH --array=0-N
#
...
export EXP_NAME="0008_20260820_query_demo_patch_gallery_hit_threshold"
