#!/bin/bash
#SBATCH --job-name=0051_20260916_macenko_slidefit_vs_patchfit_gt_eval
#SBATCH --partition=small-creator-i
#SBATCH --output=/workspace/filesrv02/kito/patch-vector-search/logs/0051_20260916_macenko_slidefit_vs_patchfit_gt_eval/%j_0051_20260916_macenko_slidefit_vs_patchfit_gt_eval.out
#SBATCH --error=/workspace/filesrv02/kito/patch-vector-search/logs/0051_20260916_macenko_slidefit_vs_patchfit_gt_eval/%j_0051_20260916_macenko_slidefit_vs_patchfit_gt_eval.out
...
export EXP_NAME="0051_20260916_macenko_slidefit_vs_patchfit_gt_eval"
