#!/bin/bash
#SBATCH --job-name=0065_20260918_local_knn_domain_correction_gt_sweep_full_gt
#SBATCH --partition=large-creator-i
#SBATCH --output=/workspace/filesrv02/kito/patch-vector-search/logs/0065_20260918_local_knn_domain_correction_gt_sweep_full_gt/%j_0065_20260918_local_knn_domain_correction_gt_sweep_full_gt.out
#SBATCH --error=/workspace/filesrv02/kito/patch-vector-search/logs/0065_20260918_local_knn_domain_correction_gt_sweep_full_gt/%j_0065_20260918_local_knn_domain_correction_gt_sweep_full_gt.out
...
export EXP_NAME="0065_20260918_local_knn_domain_correction_gt_sweep_full_gt"
