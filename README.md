...
1. glycogen の150枚を病理知識のある人にレビューしてもらう(採用率・多様性・所見レンジの
   カバー。非GT寄与スライドが本当にグリコーゲンか)
2. whole-patch テクスチャ系の別所見(hypertrophy, fatty change, ground glass)で 0015 を回す
3. アトラス seed の道(0014)は track 2(アトラス→TG-GATEs のドメインギャップを詰める)が前提
4. mitosis 系(sub-patch)を扱うなら別アプローチ(細胞検出 → パッチ内カウント等)が必要で、
   現行の埋め込み検索の枠外
